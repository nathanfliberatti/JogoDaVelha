...
public class Jogo_Da_Velha {
    ...
    public static void maquinaPrimeiraJogada(char[][] tab, char maquina){
    ...
    public static void maquinaJogada(char jogador, char maquina, char[][] tab){
        ...
        while(opcao != 3) {
            ...
            switch(opcao) {
                ...
                case 2:
                    ...
                    fazerJogada(tab, jogador);
                    imprimirTabuleiro(tab);
                    maquinaPrimeiraJogada(tab, maquina);
                    do {
                        imprimirTabuleiro(tab);
                        fazerJogada(tab, jogador);
                        maquinaJogada(jogador, maquina, tab);
                        verificarVitoria(tab, jogador, parada, contadorRodadas);
